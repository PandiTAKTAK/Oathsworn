...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        Transition mo25clone = transition.mo25clone();
        mo25clone.setSceneRoot(sceneRoot);
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            mo25clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, mo25clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, mo25clone);
    }
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition mo25clone = transition.mo25clone();
        sceneChangeSetup(viewGroup, mo25clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, mo25clone);
    }
